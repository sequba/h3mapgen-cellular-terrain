...
A handful of notable examples of the maps created are presented in Figures \ref{fig:results1}, \ref{fig:results2}, \ref{fig:results3} and \ref{fig:results4}. Also, Figure \ref{fig:voronoi} shows the terrain generated for Voronoi-distorted input map, whick looks far more realistic.

\begin{wrapfigure}{r}{0.0pt}
	\centering
	\includegraphics[scale=0.5]{voronoi}
	\caption{The terrain generated for a realistic-shape input. No \emph{super-white} cells were present so the caves' connectivity is low. For the results like this one the postprocessing is necessary to create tunnels between the rooms.}
	\label{fig:voronoi}
\end{wrapfigure}
